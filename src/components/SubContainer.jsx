  ...
  return (
    <>
      <div className="flex justify-around mt-5">
        <button
          className="border bg-red-500 py-2 px-5 rounded-2xl active:bg-blue-500"
          onClick={() => {
            setFilterMovies("Popular Movies");
          }}
        >
          {" "}
          Popular Movies{" "}
        ...
        <button
          className="border bg-red-500 py-2 px-5 rounded-2xl active:bg-blue-500"
          onClick={() => {
            setFilterMovies("Top Rated Movies");
          }}
        >
          {" "}
          Top Rated Movies{" "}
        ...
        <button
          className="border bg-red-500 py-2 px-5 rounded-2xl active:bg-blue-500"
          onClick={() => {
            setFilterMovies("Up Coming Movies");
          }}
        >
          {" "}
          Up Coming Movies{" "}
      ...
      <div className="flex justify-between">
        ...
        {posturl && <img alt="posterlogo" className="h-1/2" src={posturl} />}
        <div className="flex justify-center items-center w-1/3">
          {" "}
